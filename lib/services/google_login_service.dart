...
class GoogleLoginService {
  ...
  static Future<GoogleSignInAccount?> signInWithGoogleWithToken(String email, String accessToken) async {
    // TODO: Implement.
    return null;
  }
  ...
  static Future<GoogleSignInAccount?> signInWithGoogle(BuildContext context) async {
    ...
    bool authorized = await GoogleLoginService.googleSignIn.requestScopes(GoogleLoginService.scopes);
    if (!authorized) {
